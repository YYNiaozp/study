...
public class expressionLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"LP", "RP", "COMMA", "BOOLNOT", "MUL", "DIV", "ADD", "SUB", "MOD", "LT", 
			"LTE", "GT", "GTE", "EQ", "NE", "BOOLAND", "BOOLOR", "COND", "COLON", 
			"DOT", "ASSIGN", "TRUE", "FALSE", "NULL", "IF", "CASE", "DEFAULT", "WS", 
			"STRING", "SINGLE_QUOTED_STRING", "OCTAL", "HEX", "DECIMAL", "INTEGER", 
			"FLOAT", "ID_PUNCT", "ID", "BLOCK_COMMENT", "LINE_COMMENT"
		};
	}
