...
public interface wc_fieldVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link wc_fieldParser#space_splitted_wildcard_fieldlist}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSpace_splitted_wildcard_fieldlist(wc_fieldParser.Space_splitted_wildcard_fieldlistContext ctx);
	/**
