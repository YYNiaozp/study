...
public class LookupGrammarLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"LOOKUP", "ON", "MATCH_TYPE", "MATCH_TYPE_WILDCARD", "MATCH_TYPE_CIDR", 
			"CASE_SENSITIVE_MATCH", "TRUE", "FALSE", "AS", "WS", "LP", "RP", "COMMA", 
			"ASSIGN", "STRING", "SINGLE_QUOTED_STRING", "OCTAL", "HEX", "DECIMAL", 
			"DOT", "INTEGER", "FLOAT", "NULL", "ID_PUNCT", "ID", "BLOCK_COMMENT", 
			"LINE_COMMENT", "FORMAT", "FILENAME"
		};
	}
	...
	public LookupGrammarLexer(CharStream input) {
		super(input);
